<Query Kind="Program">
  <Reference Relative="Round42Sound\NAudio.dll">D:\Reps\r42ts\Round42Sound\NAudio.dll</Reference>
...
void Main()
{
	...
	foreach (var kvp in nameSpaceAndFiles)
	{
		...
		foreach (var value in kvp.Value)
		{
			...
			if (arrayFormat)
			{
				sb.AppendLine($"{fourSpaces}{fourSpaces}{content}");
			}
			else
			{
				sb.AppendLine($"{fourSpaces}{fourSpaces}{value.FileName}: {content}");
			}
		}
